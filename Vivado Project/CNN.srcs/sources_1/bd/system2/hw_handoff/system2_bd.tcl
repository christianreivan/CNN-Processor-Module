...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Q_0 [ create_bd_port -dir O -from 7 -to 0 Q_0 ]
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../FILTER_RAM.coe} \
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins registers_0/D]
  connect_bd_net -net clk_100MHz_1 [get_bd_ports clk_100MHz] [get_bd_pins clk_wiz/clk_in1]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins registers_0/clk] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_locked [get_bd_pins clk_wiz/locked] [get_bd_pins rst_clk_wiz_100M/dcm_locked]
  connect_bd_net -net registers_0_Q [get_bd_ports Q_0] [get_bd_pins registers_0/Q]
  ...
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins registers_0/rst] [get_bd_pins rst_clk_wiz_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins blk_mem_gen_0/ena] [get_bd_pins registers_0/en] [get_bd_pins xlconstant_0/dout]
